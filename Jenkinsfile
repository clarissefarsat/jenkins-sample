...
node () {
	...
	stage ('App-IC - Checkout') {
 	 checkout([$class: 'GitSCM', branches: [[name: '*/master']], doGenerateSubmoduleConfigurations: false, extensions: [], submoduleCfg: [], userRemoteConfigs: [[credentialsId: 'git-login', url: 'https://github.com/clarissefarsat/jenkins-sample.git']]]) 
	}
	stage ('App-IC - Build') {
 			// Maven build step
